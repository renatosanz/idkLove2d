...
function M.isCallable(obj)
	return (
		(type(obj) == "function")
		or ((type(obj) == "table") and getmetatable(obj) and getmetatable(obj).__call ~= nil)
		or false
	)
end
